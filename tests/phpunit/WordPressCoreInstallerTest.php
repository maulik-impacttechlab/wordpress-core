...
namespace Tests\maulik\Composer\phpunit;
...
use maulik\Composer\WordPressCoreInstaller;
...
class WordPressCoreInstallerTest extends TestCase {
	...
	public function testDefaultInstallDir() {
		$installer = new WordPressCoreInstaller( new NullIO(), $this->createComposer() );
		$package   = new Package( 'maulik/test-package', '1.0.0.0', '1.0.0' );
	...
	public static function resetInstallPaths() {
		$prop = new \ReflectionProperty( '\maulik\Composer\WordPressCoreInstaller', '_installedPaths' );
